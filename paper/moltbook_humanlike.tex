...
sharing identical content---representing 24.3\% of all posts.  We
...
so that higher scores indicate greater anomaly.  We use 200~estimators
and a contamination parameter of 0.05.
...
may exist at different density levels.  We set $k=20$ neighbors and
contamination to 0.05.
...
\caption{PCA projection of the 19-dimensional feature space.  Flagged
         posts (orange) occupy peripheral regions, consistent with
...
The moderate Jaccard similarity (0.554) between the 90th and 95th
percentile thresholds indicates that the 95th-percentile flagged set
is a proper subset of the 90th-percentile set, with a substantial
fraction of borderline cases removed by the tighter threshold.  The
99th percentile captures only the most extreme outliers.  The
qualitative patterns reported in the category- and community-level
analyses are stable across all three thresholds, providing confidence
that the substantive findings are not artifacts of the specific
threshold chosen.
